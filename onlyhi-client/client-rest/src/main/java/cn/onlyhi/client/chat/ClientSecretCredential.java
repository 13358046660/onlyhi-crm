...
public class ClientSecretCredential extends Credential {
    ...
    public ClientSecretCredential(String clientID, String clientSecret, String role, String appKey) {
        super(clientID, clientSecret);

        if (role.equals(Roles.USER_ROLE_APPADMIN)) {
            CLIENT_TOKEN_TARGET = EndPoints.TOKEN_APP_TARGET
                    .resolveTemplate("org_name", appKey.split("#")[0]).resolveTemplate("app_name",
                            appKey.split("#")[1]);
        }
    }
