...
import static cn.onlyhi.common.constants.Constants.BASESAVEPATH;
...
public class CourseUtilExtend {
     ...
     * @throws Exception
     */
    public static Map<Long,Long> recordCommonPeriod(String courseUuid, File recordLogsDir, ClassMateService classMateService, ClassRecordService classRecordService, ClassRoomService classRoomService, CpCourseService cpCourseService) throws Exception {
        ...
        LOGGER.info("统计有效时间段.");
        Map<Long,Long> commonPeriodMap = statisticsClassTime(courseDate, startTime, endTime, classRecordList);
        return  commonPeriodMap;
    }
    /**
     * 统计有效时间段
     *
