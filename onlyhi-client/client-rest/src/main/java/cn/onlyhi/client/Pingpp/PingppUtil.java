...
public class PingppUtil {
     ...
     */
    @Deprecated
    public static String apiKey = "sk_test_54mXT88G84eD8S8WX9LS8WjD";

    /**
     * 应用标识
     */
    public static String appId = "app_jznfLKLenTePbXT8";
    ...
    private static PingppUtil pingppUtil;

    private PingppUtil() {

    }

    private PingppUtil(String apiKey, String rsaPrivateKey) {
        Pingpp.apiKey = apiKey;
        Pingpp.privateKey = rsaPrivateKey;
    }
/*
    static {
        // 设置 API Key
...
//        Pingpp.privateKey = rsaPrivateKey;
    ...
    public static PingppUtil getInstance(String apiKey, String rsaPrivateKey) {
        if (pingppUtil == null) {
            synchronized (PingppUtil.class) {
                if (pingppUtil == null) {
                    pingppUtil = new PingppUtil(apiKey, rsaPrivateKey);
                }
            }
        }
        return pingppUtil;
