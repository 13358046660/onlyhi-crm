 ...
 */
public class PushMessage extends BasePo {
    /**
     * id
     */
    private Integer id;
    ...
    public String getPushMessageUuid() {
        return pushMessageUuid;
    }

    public void setPushMessageUuid(String pushMessageUuid) {
        this.pushMessageUuid = pushMessageUuid == null ? null : pushMessageUuid.trim();
    }
