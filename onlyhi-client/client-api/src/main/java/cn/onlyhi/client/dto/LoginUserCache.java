 ...
 * @Author wqz
 * <p>
 * Created by wqz on 2017/4/20.
 */
public class LoginUserCache extends BaseDto {
    ...
    private int agoraUid;   //声网用户Id
    private String loginName;   //登录名
//    private String role;    //cc cr
    private boolean isFirst;    //是否首次登录（是否使用的是默认密码）    false:不是，true:是
